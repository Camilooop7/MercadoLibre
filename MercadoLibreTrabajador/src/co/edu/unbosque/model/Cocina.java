...
public class Cocina extends Hogar implements Serializable { // Declara la clase Cocina, que hereda de Hogar e implementa Serializable
	...
	public Cocina(String nombre, int precio, int id, int cantidad, String imagen, boolean esDecoracion) { 
		super(nombre, precio, id, cantidad, imagen, esDecoracion); // Llama al constructor de la clase padre sin resisteAltaTemperatuta ni esPeligroso
	...
	public String toString() { 
		return super.toString() + "¿Resiste altas temperaturas? " + resisteAltaTemperatuta + " ¿Es peligroso? " + esPeligroso; 
		// Sobrescribe toString para incluir los atributos resisteAltaTemperatuta y esPeligroso
	}

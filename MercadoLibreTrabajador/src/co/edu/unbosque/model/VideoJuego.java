...
/**
 * Representa un videojuego que extiende de la clase Ocio e implementa la
...
public class VideoJuego extends Ocio implements Serializable {
	...
	/**
	 * Constructor que inicializa el videojuego con todos los atributos de Ocio y la
	...
	/**
	 * Constructor que inicializa el videojuego con todos los atributos de Ocio
	 * excepto la referencia de la consola.
	 *
	 * @param nombre      Nombre del videojuego.
	 * @param precio      Precio del videojuego.
	 * @param id          Identificador único del videojuego.

...
/**
 * Clase que representa el panel de productos de ocio.
 * Permite visualizar los productos de ocio y realizar acciones como añadir al carrito o a favoritos.
 */
public class PanelOcio extends JPanel {
     ...
     */
    public PanelOcio(Properties prop) {
        this.prop = prop;
     ...
     */
    public void agregarProducto(int cantidad, ArrayList<Ocio> listaDatos) {
        if (cantidad == -1) {
            return;
        }
